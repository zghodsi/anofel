...
anofel_setup::anofel_setup(
	...
	GadgetT(in_pb, annotation_prefix), m_mpk(in_mpk), m_comm(in_comm), m_mimc_A(in_leaf), m_tag(in_tag),
...
void anofel_setup::generate_r1cs_constraints()
{
...
void anofel_setup::generate_r1cs_witness()
{
...
const VariableT& anofel_setup::comm_x()
{
	return m_hash_commit.result_x();
}
const VariableT& anofel_setup::comm_y()
{
	return m_hash_commit.result_y();
}

const VariableT& anofel_setup::tag_x()
{
	return m_hash_tag.result_x();
}
const VariableT& anofel_setup::tag_y()
{
